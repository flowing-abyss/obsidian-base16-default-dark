...
// --b16-* token — a raw rgb()/oklch()/color() literal is just as much a
// violation as a raw hex. color-mix() is deliberately excluded: it derives
// transparent component states from semantic tokens rather than introducing
// a new authored endpoint.
const COLOUR_LITERAL =
  /#[0-9a-fA-F]{3,8}\b|\b(?:rgb|rgba|hsl|hsla|hwb|lab|lch|oklab|oklch|color)\(/g;
